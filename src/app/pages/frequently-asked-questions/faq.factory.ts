...
export class FaqFactory{
  public static build(): FaqQuestions[]{
    return [
      {
        category : " Questions : Génerales ",
        questions : [
          {
            question : "Qu'est ce que Depos'it",
            answer : " Depos’it est un coffre-fort numérique qui assure le stockage de toutes les données en sécurité et maintient l’intégrité des documents stockés. L’utilisateur aura toujours accès à tous ses documents n’importe où, n’importe quand à travers une meilleure organisation pour lui avec le classement automatisé de tous ses documents administratifs. Nos données sont stockées en France. "
          },
          {
      ...
      {
        category : "Questions : A propos de mon compte",
        questions : [
          {
      ...
      {
        category : "Questions : Sécurité & confidentialité",
        questions : [
          {
