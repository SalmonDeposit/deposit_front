...
var tarteaucitron = {
  ...
  "load": function () {
    ...
    tarteaucitron.addInternalScript(pathToLang, '', function () {
      ...
      tarteaucitron.addInternalScript(pathToServices, '', function () {
        ...
        html += '         <span class="h2-like" role="heading" aria-level="1" id="dialogTitle">'+ tarteaucitron.lang.title + '</span>';
        ...
        if (tarteaucitron.parameters.privacyUrl !== "") {
          // html += '   <br/><br/>';
          html += '   <button class="btn btn-secondary" type="button" id="tarteaucitronPrivacyUrlDialog" role="link">';
        ...
        html += '            <button type="button" id="tarteaucitronAllAllowed" class="btn btn-primary btn-grey">';
        html +=                 tarteaucitron.lang.allowAll;
        html += '            </button> ';
        html += '            <button type="button" id="tarteaucitronAllDenied" class="btn btn-primary btn-grey">';
        ...
        if (tarteaucitron.parameters.mandatory == true) {
          html += '<li id="tarteaucitronServicesTitle_mandatory" class="service-section">';
          html += '<div class="tarteaucitronTitle">';
          html += '   <span class="tarteaucitronH3" tabindex="-1">' + tarteaucitron.lang.mandatoryTitle + '</span>';
          html += '</div>';
          html += '<ul id="tarteaucitronServices_mandatory">';
          html += '<li class="tarteaucitronLine">';
          html += '   <div class="tarteaucitronName">';
          html += '       <span>' + tarteaucitron.lang.mandatoryText + '</span>';
        ...
        for (i = 0; i < cat.length; i += 1) {
          html += '         <li id="tarteaucitronServicesTitle_' + cat[i] + '" class="tarteaucitronHidden service-section">';
          html += '            <div class="tarteaucitronTitle" role="heading" aria-level="2">';
          html += '               <button type="button" class="catToggleBtn" aria-expanded="false" data-cat="tarteaucitronDetails' + cat[i] + '">' + tarteaucitron.lang[cat[i]].title + '</button>';
          html += '            </div>';
  ...
  "addService": function (serviceId) {
    ...
    if (tarteaucitron.added[service.key] !== true) {
      ...
      html += '   </div>';
      html += '   <div class="tarteaucitronAsk">';
      html += '       <button type="button" aria-label="' + tarteaucitron.lang.allow + ' ' + service.name + '" id="' + service.key + 'Allowed" class="btn btn-primary btn-grey btn-allow">';
      html +=             tarteaucitron.lang.allow;
      html += '       </button> ';
      html += '       <button type="button" aria-label="' + tarteaucitron.lang.deny + ' ' + service.name + '" id="' + service.key + 'Denied" class="btn btn-primary btn-grey btn-deny">';
    ...
    "respondAll": function (status, type, allowSafeAnalytics) {
      ...
      for (index = 0; index < tarteaucitron.job.length; index += 1) {
        ...
        if (tarteaucitron.state[key] !== status) {
          ...
          // Custom IZ-340 | close windows when All is allowed or denied.
          tarteaucitron.userInterface.closePanel();
          // --
        }
      }
